<?php
/* session_start();
if (!isset($_SESSION['user_type']) || $_SESSION['user_type'] != "deptUser") {
    session_destroy();
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu"style="background-color: #343A40">
                    ...
                    <a class="dropdown-item bg-primary" style="text-decoration-color: white"  href="manageNoticeddeptadmin.php">Manage Notice</a>
                    <a class="dropdown-item bg-primary" style="text-decoration-color: white"  href="http://localhost/master/ShowNotice.php">My notice</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="showuserTeacher.php">Teacher</a>
            </li>

        </ul>
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="DeptAdminchangePassword.php">Change Password</a>
            </li>
