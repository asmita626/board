...
if (!empty($_POST)){
    ...
    $sql = "select * from superadmin where userid = '$name'";
    ...
    if (empty($data)) {
        ...
        $_SESSION['user_type']= "userid";

        header("location:http://localhost/board/afterlogin.php");
...
<div class="col-md-4 offset-4 admin"style="margin-top: 20%">
    ...
    ?>    <form  method="post" style="opacity: 0.8;filter: alpha(opacity=80);" >
        <div class="form-group ">
            <label style="color: #fff;padding: 7px;font-weight: 600;" for="exampleInputEmail1" >SuperAdmin ID</label>
