...
if (!empty($_POST)){
    ...
    echo $sql = "INSERT into newnotice (noticesubject,noticedescription,image,category,refer_id, adminId) VALUES ('$addnoticesub','$addnoticedes','$image','$addcategory','$addreference','$adminid')";
